...
<head>
  ...
  <![endif]-->
  <?php print $scripts; ?>
       <script type="text/javascript" src="sites/all/libraries/jetmenu/jquery-1.10.1.min.js"></script>
    
    <script  type="text/javascript" src="sites/all/libraries/jetmenu/jetmenu.js"></script>
  ...
  <!-- webkit font -->
  <script src="https://use.typekit.net/nbg5wxe.js"></script>
